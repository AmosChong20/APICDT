    ...
    return (
        ...
        <Flex h={'92vh'} w={'100vw'} align='center' justify='center' letterSpacing="42%" position={'relative'}>
            ...
            <Flex w='60vw' h='15.36vh' align={'center'} justify='center' flexDir={'column'} className={styles.header}>
                ...
                <Flex fontFamily={'ZCOOL XiaoWei'} className={styles.engHeader} letterSpacing={'0.04em'} justify='center' color='#FFBD68'>11th Asia-Pacific Intervarsity Chinese Debate Tournament</Flex>
            </Flex>
        </Flex >
        // </div>
    );
